...
import msk_project.Encoder;
import msk_project.Interaction;
...
public abstract class Ambassador extends NullFederateAmbassador 
{
	...
	{
		log("Error during registration of the synchronization point " + label + ", reason:"+reason);
	}

	@Override
	public void synchronizationPointRegistrationSucceeded( String label )
	{
		log( "Synchronization Point Registration Succeeded! - " + label );
	}

	@Override
	public void announceSynchronizationPoint( String label, byte[] tag )
	{
		log( "Announce Synchronization Point: " + label );
